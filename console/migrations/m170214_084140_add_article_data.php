...
class m170214_084140_add_article_data extends Migration
{
    public function up()
    {
        $tableOptions = null;
    ...
    {
        //echo "m170214_084140_add_article_data cannot be reverted.\n";
        $this->delete('article', ['id_article' => 17]);
        $this->delete('article', ['id_article' => 16]);
        $this->delete('article', ['id_article' => 15]);
        $this->delete('article', ['id_article' => 14]);
        $this->delete('article', ['id_article' => 13]);
        $this->delete('article', ['id_article' => 12]);
        $this->delete('article', ['id_article' => 11]);
        $this->delete('article', ['id_article' => 10]);
        $this->delete('article', ['id_article' => 9]);
        $this->delete('article', ['id_article' => 8]);
        $this->delete('article', ['id_article' => 7]);
        $this->delete('article', ['id_article' => 6]);
        $this->delete('article', ['id_article' => 5]);
        $this->delete('article', ['id_article' => 4]);
        $this->delete('article', ['id_article' => 3]);

        $this->execute('ALTER TABLE `article` AUTO_INCREMENT = 3');
        //return false;
    }
