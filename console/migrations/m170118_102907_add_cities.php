...
class m170118_102907_add_cities extends Migration {
	...
	$this->createTable("{{country}}", [
	    'country_id' => $this->primaryKey(11),
	    'city_id' => $this->integer(11),
	    'name' => $this->string(128),
		], $tableOptions);

	$this->execute("INSERT INTO `city` (`city_id`, `country_id`, `region_id`, `name`) VALUES
(6, 4, 5, 'Балларат'),
(7, 4, 5, 'Бендиго'),
(8, 4, 5, 'Варрнамбул'),
(9, 4, 5, 'Водонга'),
...
(15789520, 582106, 15789405, 'Кингстон');");
	...
	$this->execute("INSERT INTO `country` (`country_id`, `city_id`, `name`) VALUES
(4, 0, 'Австралия'),
(63, 0, 'Австрия'),
(81, 0, 'Азербайджан'),
(173, 0, 'Ангуилья'),
...
(7716093, 0, 'Арулько');
");
	$this->execute("INSERT INTO `region` (`region_id`, `country_id`, `city_id`, `name`) VALUES
(5, 4, 0, 'Виктория'),
