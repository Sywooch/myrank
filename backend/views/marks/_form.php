...
<div class="marks-form">
    ...
    <div class="row">
        ...
        <div class="col-md-4"><?= $form->field($model, 'short_name_en')->textInput(['maxlength' => true]) ?></div>
        <div class="col-md-4"><?= $form->field($model, 'short_name_ua')->textInput(['maxlength' => true]) ?></div>
    </div>
