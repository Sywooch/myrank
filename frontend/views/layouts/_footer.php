...
<footer class="b-footer">
	...
	<div class="container">
		...
		<div class="col-xs-12 col-sm-6 col-sm-push-6 col-md-3 col-md-push-0 col-lg-3">
			...
			<ul>
			    <li><a href="#"><?= \Yii::t('app','ENTER'); ?></a></li>
			    <li><a href="#"><?= \Yii::t('app','REGISTER'); ?></a></li>
			    <li><a href="#"><?= \Yii::t('app','RESTORE_ACCESS'); ?></a></li>
			    <li><a href="#"><?= \Yii::t('app','RECOMMENDATIONS_EXECUTOR'); ?></a></li>
			    <li><a href="#"><?= \Yii::t('app','RECOMMENDATIONS_CUSTOMER'); ?></a></li>
			    <li><a href="#"><?= \Yii::t('app','SITE_SEARCH'); ?></a></li>
			    <li><a href="#"><?= \Yii::t('app','PAID_OPTIONS_IN_PROJECTS'); ?></a></li>
			    <li><a href="#"><?= \Yii::t('app','SITE_ADS'); ?></a></li>
			</ul>
		    </div>
		</div>
