...
$model->isCompany ? \Yii::t('app', 'COMPANY_PROFILE') . " " . $model->name : \Yii::t('app', 'USER_PROFILE') . " " . $model->fullName;
$this->params['breadcrumbs'] = [
    [
        'label' => \Yii::t('app', 'COMPANY_PROFILE') . " " . $model->name,
        'url' => ['company/profile', 'id' => $model->id]
    ],
    ['label' => $this->title, 'url' => ['company/structure', 'id' => $model->id]]
];
?>
<div class = "container">
    <div id = "main">
        ...
        if (($item > 0)) {
            ?>
                                                <li class = "b-list b-list_dotted">
                                                    <span class = "b-list__name">
            <?= isset($allMarksName[$key]) ? $allMarksName[$key] : 'Оценка удалена' ?>
                                                    </span>
