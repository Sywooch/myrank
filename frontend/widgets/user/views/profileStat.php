...
<div class="b-user__stats">
    <div class="b-user__stats__item">
        <div class="b-user__stats__item__content">
            <a href="<?= Url::toRoute(["$contr/alltrustees", 'id' => $model->id]) ?>" style="text-decoration: none">
    ...
    <div class="b-user__stats__item">
        <div class="b-user__stats__item__content">
            <a href="<?= Url::toRoute(["$contr/allmarks", 'id' => $model->id]) ?>" style="text-decoration: none">
    ...
    <div class="b-user__stats__item">
        <div class="b-user__stats__item__content">
            <a href="<?= Url::toRoute(["$contr/alltestimonials", 'id' => $model->id]) ?>" style="text-decoration: none">
